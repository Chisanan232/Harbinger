...
Before you begin contributing to Harbinger, ensure your development environment meets these requirements.
...
1. **Clone the repository**:
   ```bash
   git clone https://github.com/Chisanan232/Harbinger.git
   cd your_repo
   ```
