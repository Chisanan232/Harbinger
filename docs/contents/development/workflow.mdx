...
This guide outlines the recommended workflow for contributing to the Harbinger project.
...
- Browse existing [GitHub Issues](https://github.com/Chisanan232/Harbinger/issues) to find something to work on
...
1. Go to the [Harbinger repository](https://github.com/Chisanan232/Harbinger)
...
git remote add upstream https://github.com/Chisanan232/Harbinger.git
...
- Ask questions in the [GitHub Discussions](https://github.com/Chisanan232/Harbinger/discussions)
